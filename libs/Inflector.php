...
class Inflector
{
    ...
    */
    ...
    /**
    * Adds proper Indefinite article to a word
    * 
    * Adds "a" to "Person" => "a Person"
	* Adds "an" to "umbrella" => "an umbrella"
	* Adds "a" to "euphenism" => "a euphenism"
    * 
    * @access public
    * @static
    * @see articalize
    * @param    string    $input    Word to be articalized
    * @return string ArticalizedWord
    */
	public static function articalizeAN($input, $count=1) {
		return self::A($input, $count);
	}

	public static function articalize($input, $count=1) {
		$matches = array();
	...
	public static function _indef_article($word, $count) {
